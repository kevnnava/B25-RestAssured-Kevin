...
public class HamcrestMatchersApiTests {
    ...
    public void test1() {
        given()
                ...
                .pathParam("id", 15)
                .when()
                .get("http://34.230.89.69:8000/api/spartans/{id}")
                .then()
                .statusCode(200)
                .and()
    ...
    @Test
    public void test3() {
        // verify "Leonel", "Andrii", "Anreas" are inside all the teachers
        ...
        given()
                ...
                .statusCode(200)
                .and()
                .body("teachers.firstName", hasItems("Leonel", "Andrii", "Anreas"));
